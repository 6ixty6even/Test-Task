...
public class Tests extends BaseTest{
        ...
        public void test9(){
            try {
                //go to product page
                driver.get("https://www.amazon.com/Nintendo-SwitchTM-Neon-Blue-Joy%E2%80%91ConTM-Switch/dp/B0BFJWCYTL/ref=lp_16225009011_1_8?th=1");
                sleep(2);
                //add to card goods
                elementByXpath("//input[@type='submit']").click();
                sleep(2);
                //go to card
                elementByXpath("//a[@href='/gp/cart/view.html?ref_=nav_cart']").click();
                sleep(2);
                //Proceed to checkout
                elementByXpath("input[@name='proceedToRetailCheckout']").click();
                //Proceed to checkout
            }finally {
                sleep(30);
                driver.quit();
